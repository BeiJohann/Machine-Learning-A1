...
if __name__ == '__main__':
    ...
    parser.add_argument("-L", "--load_model", dest="model_path", type=str,
                        help="Specify the model path")
    parser.add_argument("-X", "--test_sent", dest="x_file", type=str,
                        help="Specify the file from where the sentences are loaded")
    parser.add_argument("-Y", "--test_label", dest="y_file", type=str,
                        help="Specify the file from where the Labels are loaded")
